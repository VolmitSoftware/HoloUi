...
public record ContainerPreviewTheme(
  ...
  public static ContainerPreviewTheme resolve(Container container) {
    ...
    return switch (type) {
      case CHEST ->
          new ContainerPreviewTheme("&6", "&8", "&0", "&6[ Chest ]", "&6>>", Style.style(NamedTextColor.WHITE));
      case TRAPPED_CHEST ->
          new ContainerPreviewTheme("&c", "&8", "&0", "&c[ Trapped Chest ]", "&c>>", Style.style(NamedTextColor.RED));
      case BARREL ->
          new ContainerPreviewTheme("&6", "&8", "&0", "&6[ Barrel ]", "&6>>", Style.style(NamedTextColor.GOLD));
      case DISPENSER ->
          new ContainerPreviewTheme("&7", "&8", "&0", "&7[ Dispenser ]", "&7>>", Style.style(NamedTextColor.WHITE));
      case DROPPER ->
          new ContainerPreviewTheme("&8", "&7", "&0", "&8[ Dropper ]", "&8>>", Style.style(NamedTextColor.GRAY));
      case HOPPER ->
          new ContainerPreviewTheme("&8", "&7", "&0", "&8[ Hopper ]", "&8>>", Style.style(NamedTextColor.GRAY));
      case FURNACE ->
          new ContainerPreviewTheme("&6", "&8", "&0", "&6[ Furnace ]", "&6>>", Style.style(NamedTextColor.WHITE));
      case SMOKER ->
          new ContainerPreviewTheme("&e", "&6", "&0", "&e[ Smoker ]", "&e>>", Style.style(NamedTextColor.GOLD));
      case BLAST_FURNACE ->
          new ContainerPreviewTheme("&b", "&3", "&0", "&b[ Blast Furnace ]", "&b>>", Style.style(NamedTextColor.AQUA));
      default ->
          new ContainerPreviewTheme("&6", "&8", "&0", "&6[ Container ]", "&6>>", Style.style(NamedTextColor.WHITE));
    };
  }
